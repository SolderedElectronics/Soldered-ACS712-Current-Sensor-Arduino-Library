...
// VERSION: 0.2.2
//    DATE: 2020-08-02
// PURPOSE: _ACS712 library - current measurement
//
// Tested with a RobotDyn _ACS712 20A breakout + UNO.
//
...
class _ACS712
{
  public:
    ...
    inline void setMidPoint(uint16_t mp)
    {
        _midPoint = mp;
    };
    inline uint16_t getMidPoint()
    {
        return _midPoint;
    };
    inline void incMidPoint()
    {
        _midPoint++;
    };
    inline void decMidPoint()
    {
        _midPoint--;
    };
    ...
    // default sinus.
    inline void setFormFactor(float ff = ACS712_FF_SINUS)
    {
        _formFactor = ff;
    };
    inline float getFormFactor()
    {
        return _formFactor;
    };
    ...
    //  noise defaults 21
    inline void setNoisemV(uint8_t noisemV = 21)
    {
        _noisemV = noisemV;
    };
    inline uint8_t getNoisemV()
    {
        return _noisemV;
    };
    ...
    // AC and DC
    inline void setmVperAmp(uint8_t mva)
    {
        _mVperAmpere = mva;
    };
    inline uint8_t getmVperAmp()
    {
        return _mVperAmpere;
    };
